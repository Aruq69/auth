...
serve(async (req) => {
  ...
  try {
    ...
    if (action === 'get_auth_url') {
      ...
      const scopes = 'https://graph.microsoft.com/MailboxSettings.ReadWrite https://graph.microsoft.com/Mail.Read https://graph.microsoft.com/User.Read offline_access';
